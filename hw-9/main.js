...
block.innerText = 'HOME WORK 9 DOM';
...
//     courseBlock.textContent = `Title: ${course.title}, Duration: ${course.monthDuration} months`;
...
//     titleH1.className = 'heading';
//     titleH1.textContent = course.title;
//
//     const durationP = document.createElement('p');
//     durationP.className = 'description';
//     durationP.textContent = `Duration: ${course.monthDuration} months`;
//
...
simpsonsContainer.className = 'container';
...
for (const course of coursesArray) {
    ...
    courseBlock.style.backgroundColor = 'silver'
    courseBlock.className = 'course-block';

    courseBlock.innerHTML = `
        <div class="title-block">Title: ${title}</div>
        <div class="duration-block">Duration: ${monthDuration} months, ${hourDuration} hours</div>
